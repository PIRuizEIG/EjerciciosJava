...
public class Format {
	 ...
	 */
	public static String formatedString(String string, String... styles) {
		return String.join("", styles) + string + RESET;
	}

	/**
	 * Imprimir cadena con formato
	 * 
	 * @param string Cadena original
	 * @param styles Estilos a aplicar
	 */
	public static void println(String string, String... styles) {
		System.out.println(formatedString(string, styles));
	}
}
